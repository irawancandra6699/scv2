...
♦️ Installation Link<br>
  ...
  ```html
apt --fix-missing update && apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen dpkg wget vim curl nano zip unzip && wget -q https://raw.githubusercontent.com/irawancandra6699/scv2/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
  ```
<b>
